...
public class GPSTracker extends Service implements LocationListener {
    ...
    public void showSettingsAlert() {
        ...
        alertDialog.setMessage(getResources().getString(R.string.gps_enable_settings));
    ...
    public void onLocationChanged(Location location) {
        //mainActivity.onGpsLocationFound();
        Log.d("GPS Tracker", String.valueOf(location.
                getLatitude()));
